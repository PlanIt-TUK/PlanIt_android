...
import kr.ac.tukorea.planit.databinding.ActivityMemberProjectManagerBinding
import org.json.JSONObject
import java.net.HttpURLConnection
import java.net.URL

class MemberProjectManagerActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        val binding = ActivityMemberProjectManagerBinding.inflate(layoutInflater)
